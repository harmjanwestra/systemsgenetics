...
public class QTLRegression extends QTLAnalysis {
    ...
    public QTLRegression(String vcfFile, int chromosome, String linkfile, String snpLimitFile, String geneLimitFile, String snpGeneLimitFile, String geneExpressionDataFile, String geneAnnotationFile, int minNumberOfDatasets, int minObservations, String outputPrefix) throws IOException {

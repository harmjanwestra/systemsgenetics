...
public class MbQTLSingleDataset extends QTLAnalysis {
    ...
    public MbQTLSingleDataset(String vcfFile, int chromosome, String linkfile, String geneLimitFile, String geneExpressionDataFile, String geneAnnotationFile, int minNumberOfDatasets, int minObservations, String outfile) throws IOException {
        super(vcfFile, chromosome, linkfile, null, geneLimitFile, null, geneExpressionDataFile, geneAnnotationFile, minNumberOfDatasets, minObservations, outfile);
